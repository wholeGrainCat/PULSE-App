...
class BreathingService {
  ...
  BreathingService() {
    _breathingRef = _firestore.collection('breaths').withConverter<Breathing>(
        fromFirestore: (snapshots, _) => Breathing.fromJson(
              snapshots.data()!,
            ),
...
class BreathingVideoService {
  ...
  BreathingVideoService() {
    _breathingvideoRef =
        _firestore.collection('breathingvideos').withConverter<BreathingVideo>(
            fromFirestore: (snapshots, _) => BreathingVideo.fromJson(
                  snapshots.data()!,
                ),
