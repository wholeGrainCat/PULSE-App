...
class CrisisSupportRepository {
  ...
  Future<void> updateMentalHealthHotline(
      String docID, String mhName, String mhNumber) {
  ...
  Future<void> updateEmergencyHotline(
      String docID, String ecName, String ecNumber) {
