...
class CreateBreathingPage extends StatelessWidget {
  const CreateBreathingPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController line4Controller = TextEditingController();
    final TextEditingController line5Controller = TextEditingController();
    final TextEditingController line6Controller = TextEditingController();
    final TextEditingController line7Controller = TextEditingController();
    final TextEditingController line8Controller = TextEditingController();
    final TextEditingController line9Controller = TextEditingController();
    final TextEditingController line10Controller = TextEditingController();
                ...
                onPressed: () {
                  ...
                  if (title.isNotEmpty &&
                    ...
                    FirebaseFirestore.instance.collection('breaths').add({
                      ...
                      _showDialog(
                        context,
                        "Breathing Exercise added successfully.",
                        Icons.check_circle,
                        Colors.green,
                        navigateBack: true,
                      );
                      ...
                      _showDialog(
                        context,
                        "Failed to add Breathing Exercise: $error",
                        Icons.cancel,
                        Colors.red,
                      );
                    });
