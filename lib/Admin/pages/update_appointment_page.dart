...
class _UpdateAppointmentPageState extends State<UpdateAppointmentPage> {
  ...
  void initState() {
    ...
    _selectedTime = TimeOfDay.fromDateTime(widget.appointment.appointmentDate.toDate());
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          _buildConfirmButton(context, widget.appointment, _selectedDay, _selectedTime),
