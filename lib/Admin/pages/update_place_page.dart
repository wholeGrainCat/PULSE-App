...
class UpdatePlacePage extends StatelessWidget {
  ...
  const UpdatePlacePage(
      {super.key, required this.placeId, required this.place});

  @override
  Widget build(BuildContext context) {
    final TextEditingController dayController =
        TextEditingController(text: place.day);
    final TextEditingController timeController =
        TextEditingController(text: place.time);
                ...
                onPressed: () {
                  ...
                  if (day.isNotEmpty && time.isNotEmpty) {
                    FirebaseFirestore.instance
                      ...
                      _showDialog(
                        context,
                        "Failed to update opening hours: $error",
                        Icons.cancel,
                        Colors.red,
                      );
                    });
