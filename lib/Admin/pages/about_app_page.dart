          ...
          SafeArea(
            child: Column(
              children: [
                ...
                Expanded(
                  child: ListView(
                    padding: const EdgeInsets.symmetric(horizontal: 16.0), // Page padding
                    children: [
                      const SizedBox(height: 30), // Space between AppBar and content
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 10), // Space between app name and version
                            const Text(
                      ...
                      const SizedBox(height: 20), // Space before acknowledgment card
                      ...
                      _buildCard(
                        ...
                        color: const Color(0xFF9747FF), // Light violet card color
                      ),
                    ],
                  ),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(icon, color: Colors.white, size: 30), // Icon with white color
