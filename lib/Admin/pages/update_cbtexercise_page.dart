...
class UpdateCbtexercisePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController numberController = TextEditingController(text: cbtexercise.number);
    final TextEditingController titleController = TextEditingController(text: cbtexercise.title);
    final TextEditingController urlController = TextEditingController(text: cbtexercise.url);
    return Scaffold(
