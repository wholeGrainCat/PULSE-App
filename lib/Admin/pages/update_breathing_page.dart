...
class UpdateBreathingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController titleController = TextEditingController(text: breathing.title);
    final TextEditingController introductionController = TextEditingController(text: breathing.introduction);
    final TextEditingController line1Controller = TextEditingController(text: breathing.line1);
    final TextEditingController line2Controller = TextEditingController(text: breathing.line2);
    final TextEditingController line3Controller = TextEditingController(text: breathing.line3);
    final TextEditingController line4Controller = TextEditingController(text: breathing.line4);
    final TextEditingController line5Controller = TextEditingController(text: breathing.line5);
    final TextEditingController line6Controller = TextEditingController(text: breathing.line6);
    final TextEditingController line7Controller = TextEditingController(text: breathing.line7);
    final TextEditingController line8Controller = TextEditingController(text: breathing.line8);
    final TextEditingController line9Controller = TextEditingController(text: breathing.line9);
    final TextEditingController line10Controller = TextEditingController(text: breathing.line10);
    final TextEditingController conclusionController = TextEditingController(text: breathing.conclusion);
