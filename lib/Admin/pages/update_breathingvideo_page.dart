...
class UpdateBreathingVideoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController thumbnailController = TextEditingController(text: breathingvideo.thumbnail);
    final TextEditingController titleController = TextEditingController(text: breathingvideo.title);
    final TextEditingController urlController = TextEditingController(text: breathingvideo.url);
