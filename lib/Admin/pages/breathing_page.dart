...
import 'package:pulse/pages/create_breathing_page.dart';
import 'package:pulse/pages/create_breathingvideo_page.dart';
import 'package:pulse/pages/update_breathing_page.dart';
import 'package:pulse/pages/update_breathingvideo_page.dart';
import 'package:pulse/services/breathing_service.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    if (breathing.conclusion != null &&
                        breathing.conclusion!.isNotEmpty)
                      Text(
