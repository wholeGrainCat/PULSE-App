...
import 'package:pulse/models/appointment.dart';
import 'package:pulse/pages/update_appointment_page.dart';
import 'package:pulse/services/appointment_service.dart';
...
class _AppointmentPageState extends State<AppointmentPage> {
  ...
  Widget buildReservedAppointmentCard(Appointment appointment) {
    final dateTime = appointment.appointmentDate.toDate()..subtract(const Duration(hours: 8));
    final time = "${dateTime.hour}:${dateTime.minute.toString().padLeft(2, '0')} ${dateTime.hour < 12 ? "AM" : "PM"}";
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UpdateAppointmentPage(appointment: appointment),
                      ),
                    );
                  },
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  "Pending",
                  style: TextStyle(
                    color: isPendingSelected ? Colors.white : Colors.purpleAccent,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                  ),
                ),
