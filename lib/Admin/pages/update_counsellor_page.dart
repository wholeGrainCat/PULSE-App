...
class UpdateCounsellorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController nameController = TextEditingController(text: counsellor.name);
    final TextEditingController phoneNumberController = TextEditingController(text: counsellor.phoneNumber);
    final TextEditingController emailController = TextEditingController(text: counsellor.email);
    final TextEditingController imageController = TextEditingController(text: counsellor.image);
