...
import 'package:pulse/models/advertisement.dart';
import 'package:pulse/models/breathing.dart';
import 'package:pulse/models/cbtexercise.dart';
import 'package:pulse/pages/advertisement_page.dart';
import 'package:pulse/pages/appointment_page.dart';
import 'package:pulse/pages/breathing_page.dart';
import 'package:pulse/pages/cbtexercise_page.dart';
import 'package:pulse/services/advertisement_service.dart';
import 'package:pulse/models/meditation.dart';
import 'package:pulse/pages/meditation_page.dart';
import 'package:pulse/services/meditation_service.dart';
import 'package:pulse/pages/counsellor_page.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

final List<Color> backgrounds = [
  Color.fromARGB(128, 164, 227, 232), // A4E3E8 with 50% opacity
  Color.fromARGB(128, 217, 246, 92), // D9F65C with 50% opacity
  Color.fromARGB(128, 175, 150, 245), // AF96F5 with 50% opacity
];
...
Widget buildFloatingActionButton() {
  ...
  Widget buildCategoryCard(String title, String description, String imageUrl, Color backgroundColor) {
    return GestureDetector(
      onTap: () {
        ...
        if (title == "CBT Exercises") {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => CbtexercisePage()),
          );
        }
      },
      child: Card(
