          ...
          Column(
            children: [
              AppBar(
                title: const Text(
                  'Notifications',
                  style: TextStyle(color: Colors.black, fontSize: 25, fontFamily: 'Roboto'),
                ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      margin: const EdgeInsets.only(bottom: 20), // Spacing between notifications
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(8), // Adjust image padding
                              child: Image.asset(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8), // Space between description and time
                                Text(
