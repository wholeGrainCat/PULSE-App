  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Image.asset(
            "assets/images/screen1.png"), // Displays the specified image from the assets
        const SizedBox(
            height: 40), // Adds vertical space between the image and text
        // Title text displayed below the image
        const Text(
          "Make an appointment", // Main title
          style: TextStyle(
        ...
        Container(
          ...
          child: Text(
            "Make an appointment with Unimas Counsellor", // Subtitle text
            style: TextStyle(
